export const ERROR_TYPES = [
  ...
  { key: 'stylistic', label: 'Стилистика', color: 'bg-violet-100 text-violet-700 border-violet-300', headerColor: 'bg-violet-50 text-violet-800', dotColor: 'bg-violet-500' },
  ...
  { key: 'wordOrder', label: 'Порядок слов', color: 'bg-indigo-100 text-indigo-700 border-indigo-300', headerColor: 'bg-indigo-50 text-indigo-800', dotColor: 'bg-indigo-500' },
